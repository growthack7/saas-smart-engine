...
description: Skill Maestra de arquitectura de diseño UI/UX, animación de alto rendimiento y experiencia de usuario impecable. Integra el sistema de movimiento de Emil Kowalski, la matriz de 20 comandos y anti-patrones de Impeccable, el motor UI/UX Pro Max (Design Tokens & Bento Grid), las 10 Heurísticas de Usabilidad de Nielsen y el flujo Task-Driven UI Improvement para crear interfaces nivel Apple/Airbnb/Stripe sin fallos.
---
...
```mermaid
flowchart TD
    A[UI/UX Task Request] --> B[1. Task-Driven UI Improvement Workflow]
    B --> C[2. UI/UX Pro Max Architecture & Design Tokens]
    C --> D[3. UX Heuristics & Nielsen Guidelines Check]
    D --> E[4. Impeccable Engine 20 Comandos & Anti-Patterns]
    E --> F[5. Emil Kowalski Motion & Micro-interactions]
    F --> G[Quality Gate /audit & Instant Feedback <100ms]
```
...
* 🎬 [Guía de Movimiento y Animaciones de Emil Kowalski](file:///C:/Users/Erick%20Diaz/.gemini/config/skills/ui-ux-performance-architect/references/emil_kowalski_motion.md)
* 💎 [Catálogo de 20 Comandos e Impeccable Anti-Patterns](file:///C:/Users/Erick%20Diaz/.gemini/config/skills/ui-ux-performance-architect/references/impeccable_commands_rules.md)
* 🧠 [Heurísticas de Usabilidad de Nielsen & UX Guidelines](file:///C:/Users/Erick%20Diaz/.gemini/config/skills/ui-ux-performance-architect/references/ux_heuristics_guidelines.md)
